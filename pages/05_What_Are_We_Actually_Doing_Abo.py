...
st.markdown("""<div class="page-context">This chapter examines three concrete individual sustainability behaviors captured in the
lifestyle survey: the percentage of people following a plant-based or vegetarian diet, the percentage
who own an electric vehicle, and the percentage who recycle regularly.<br><br>
These three behaviors represent different levels of commitment and cost — diet is a daily choice,
recycling is habitual, and EV ownership requires significant investment.
Together they paint a picture of where individuals are — and are not — willing to act.<br><br>
The pattern that emerges is striking: <strong style="color:#ffffff">the countries with the highest
ecological footprints show the lowest rates of all three sustainable behaviors</strong>.
Countries living furthest beyond their means are also doing the least
to change course at the individual level.</div>""", unsafe_allow_html=True)

col_list = st.columns(4)
col_list[0].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#2ecc71">~27%</div>
    <div class="fact-label">Average plant-based/vegan diet across all countries</div>
</div>""", unsafe_allow_html=True)
col_list[1].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#2ecc71">~26%</div>
    <div class="fact-label">Average regular recycling rate across countries</div>
</div>""", unsafe_allow_html=True)
col_list[2].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#2ecc71">Low</div>
    <div class="fact-label">EV ownership still very low across most countries</div>
</div>""", unsafe_allow_html=True)
col_list[3].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#2ecc71">Gap 📉</div>
    <div class="fact-label">Biggest gap in highest-footprint countries</div>
</div>""", unsafe_allow_html=True)

st.markdown('<div style="height:0.5rem"></div>', unsafe_allow_html=True)

st.markdown("""<div class="insight-box">
    <div style="color:#2ecc71; font-weight:700; margin-bottom:0.5rem">Key Insight</div>
    <div style="color:#e0e0e0; font-size:1rem; line-height:1.8"><strong style="color:#ffffff">Awareness without action is just guilt.</strong>
The behavior gap is real and measurable: countries that cause the most planetary damage are also
the ones where the fewest people adopt sustainable daily behaviors. This is not ignorance —
global awareness of climate change is near-universal. It is a failure of <em>will</em>,
not knowledge. <strong style="color:#ffffff">Individual action matters —
but systemic change cannot wait for individuals to lead.</strong></div>
</div>""", unsafe_allow_html=True)



st.markdown("---")
components.iframe("https://public.tableau.com/views/VizCon2026-BehaviorGap/BehaviorGap?:embed=yes&:showVizHome=no&:toolbar=yes", height=650, scrolling=True)
st.markdown("---")
st.markdown("""<div class="source-bar">Source: Global Mental Health & Lifestyle Survey — 10,000 respondents · 
    <a href="https://public.tableau.com/views/VizCon2026-BehaviorGap/BehaviorGap" target="_blank" style="color:#3498db">Open in Tableau ↗</a></div>""",
    unsafe_allow_html=True)
