...
st.markdown('<div class="page-subtitle">We all have exactly 24 hours. Yet the way we fill them — and the cost of those choices — differs dramatically across the globe.</div>', unsafe_allow_html=True)
st.markdown('<div class="divider"></div>', unsafe_allow_html=True)

st.markdown("""<div class="page-context">What does a typical day look like for someone in India versus Canada? In Japan versus Brazil?
Across 10,000 survey respondents spanning 10 countries, this chapter examines the building blocks of daily life —
how much we sleep, how often we exercise, how long we stare at screens, how far we commute, and how many times
we board a plane each year.<br><br>
The first surprise: <strong style="color:#ffffff">our routines are eerily similar</strong>. Sleep hours,
exercise frequency, and screen time are nearly identical across wildly different cultures and income levels.
The second surprise: despite nearly identical routines, the <strong style="color:#ffffff">carbon cost of
those routines varies by up to 6%</strong> between countries — driven by energy sources, transport infrastructure,
and consumption habits invisible in daily life.</div>""", unsafe_allow_html=True)

col_list = st.columns(4)
col_list[0].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#3498db">7.0 hrs</div>
    <div class="fact-label">Average sleep — nearly identical across all 10 countries</div>
</div>""", unsafe_allow_html=True)
col_list[1].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#3498db">6.5 hrs</div>
    <div class="fact-label">Daily screen time — we are all glued to our devices</div>
</div>""", unsafe_allow_html=True)
col_list[2].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#3498db">3 days/wk</div>
    <div class="fact-label">Exercise frequency — remarkably consistent globally</div>
</div>""", unsafe_allow_html=True)
col_list[3].markdown("""<div class="fact-card">
    <div class="fact-num" style="color:#3498db">30 min</div>
    <div class="fact-label">Average commute — varies most between countries</div>
</div>""", unsafe_allow_html=True)
...
st.markdown("""<div class="info-box">
    ...
    <div style="color:#e0e0e0; font-size:1rem; line-height:1.8"><strong style="color:#ffffff">The Sameness Surprise:</strong>
Despite oceans, cultures, and income gaps separating them, people in Australia, India, Japan, Brazil,
and the USA sleep the same, exercise the same, and spend the same hours on screens.
Our daily routines are nearly identical. The real difference lies not in <em>how</em> we live —
but in the invisible <strong style="color:#ffffff">planetary cost</strong> of how we live.</div>
</div>""", unsafe_allow_html=True)



st.markdown("---")
components.iframe("https://public.tableau.com/views/VizCon2026-Same24Hours/Same24Hours?:embed=yes&:showVizHome=no&:toolbar=yes", height=650, scrolling=True)
st.markdown("---")
st.markdown("""<div class="source-bar">Source: Global Mental Health & Lifestyle Survey — 10,000 respondents, 10 countries · 
    <a href="https://public.tableau.com/views/VizCon2026-Same24Hours/Same24Hours" target="_blank" style="color:#3498db">Open in Tableau ↗</a></div>""",
    unsafe_allow_html=True)
