...
st.markdown('<div class="page-subtitle">18 years of happiness data. Consumption keeps rising. Emissions keep rising. But are people actually getting any happier?</div>', unsafe_allow_html=True)
st.markdown('<div class="divider"></div>', unsafe_allow_html=True)

st.markdown("""<div class="page-context">
    The World Happiness Report has tracked happiness scores across countries since 2005,
    using the Cantril Ladder — a 0 to 10 scale where respondents rate their lives.
    Respondents imagine a ladder where the best possible life is a 10 and the worst is a 0,
    and say which rung they currently stand on.<br><br>
    This chapter plots happiness trends for all 10 countries from 2005 to 2023, revealing what
    nearly two decades of rising consumption, rising emissions, and rising inequality has done
    to human wellbeing. The answer is sobering:
    <strong style="color:#ffffff;">almost nothing</strong>.
    Happiness scores have remained remarkably flat across most nations despite significant
    economic growth and rising material consumption.<br><br>
    The brief dip visible around <strong style="color:#ffffff;">2020 captures the COVID-19 effect</strong>
    — a stark reminder that happiness is fragile and deeply tied to social connection, not material things.
    India has remained consistently at the bottom — a reflection of persistent poverty and inequality,
    not a failure of culture or values. The top nations have barely moved in 18 years despite
    becoming significantly wealthier and consuming significantly more.
</div>""", unsafe_allow_html=True)

col1, col2, col3, col4 = st.columns(4)
with col1:
    st.markdown("""<div class="fact-card"><div class="fact-num">7.03</div>
    <div class="fact-label">Australia 2023 — highest happiness score in dataset</div></div>""", unsafe_allow_html=True)
with col2:
    st.markdown("""<div class="fact-card"><div class="fact-num" style="color:#e74c3c;">4.68</div>
    <div class="fact-label">India 2023 — lowest happiness score in dataset</div></div>""", unsafe_allow_html=True)
with col3:
    st.markdown("""<div class="fact-card"><div class="fact-num" style="color:#f39c12;">Flat 📊</div>
    <div class="fact-label">Most countries barely changed since 2005</div></div>""", unsafe_allow_html=True)
with col4:
    st.markdown("""<div class="fact-card"><div class="fact-num">2020 📉</div>
    <div class="fact-label">COVID dip visible in nearly every country</div></div>""", unsafe_allow_html=True)

st.markdown('<div style="height:0.5rem"></div>', unsafe_allow_html=True)
st.markdown("""<div class="info-box">
    <div style="color:#3498db; font-weight:700; margin-bottom:0.5rem;">Key Insight — We Are Consuming More and Living No Happier</div>
    <div style="color:#a0c4d8; font-size:1rem; line-height:1.8;">
        ...
        Ecological footprints have deepened. Yet happiness scores have barely moved in 18 years.<br><br>
        ...
        The data suggests we may have confused comfort with joy, and accumulation with fulfilment.
        The hedonic treadmill is real — and it is taking us nowhere while taking the planet everywhere.
    </div>
</div>""", unsafe_allow_html=True)
...
st.markdown("""<div class="source-bar">Source: World Happiness Report 2024 — Gallup World Poll 2005-2023 ·
    <a href="https://public.tableau.com/views/VizCon2026-HappinessTrend/HappinessTrend" target="_blank" style="color:#3498db;">Open in Tableau ↗</a>
</div>""", unsafe_allow_html=True)
