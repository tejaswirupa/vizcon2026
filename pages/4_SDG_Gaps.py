...
<style>
    ...
    .insight-box { background:linear-gradient(135deg,#1a1a3a,#2d2d5a); border-left:4px solid #9b59b6; 
...
st.markdown('<div class="page-subtitle">The UN's Sustainable Development Goals are a global report card. Here's how our 10 countries score — and where they're failing.</div>', unsafe_allow_html=True)

col1, col2, col3 = st.columns(3)
with col1:
    st.markdown('''<div class="fact-card">
        <div class="fact-num">83.4</div>
        <div class="fact-label">🇩🇪 Germany — highest<br>SDG overall score</div>
    </div>''', unsafe_allow_html=True)
with col2:
    st.markdown('''<div class="fact-card">
        <div class="fact-num">63.4</div>
        <div class="fact-label">🇮🇳 India — lowest<br>SDG overall score</div>
    </div>''', unsafe_allow_html=True)
with col3:
    st.markdown('''<div class="fact-card">
        <div class="fact-num">16.9</div>
        <div class="fact-label">🇦🇺 Australia — worst score<br>on Climate Action (G13)</div>
    </div>''', unsafe_allow_html=True)
...
st.markdown('''<div class="insight-box">
    ...
    <div style="color:#d7a0f5; font-size:1rem; line-height:1.6">
        ...
        the lowest of all 10 countries. Meanwhile India, despite being the poorest, 
        scores 94.3 on Climate Action. The pattern is clear: wealth enables destruction.
    </div>
</div>''', unsafe_allow_html=True)
...
st.markdown('''<div style="color:#718096; font-size:0.85rem; text-align:center">
    ...
    <a href="https://public.tableau.com/views/VizCon2026-SDGGaps/SDGGaps" style="color:#3498db">View in Tableau ↗</a>
</div>''', unsafe_allow_html=True)
col1, col2 = st.columns([4,1])
with col2:
    if st.button("Next Chapter →", type="primary"):
        st.switch_page("pages/5_🌱_Behavior_Gap.py")
