...
<style>
    ...
    .insight-box { background:linear-gradient(135deg,#1a2a3a,#2d3d5e); border-left:4px solid #3498db; border-radius:8px; padding:1.2rem 1.5rem; margin:1rem 0; }
...
st.markdown('<div class="page-subtitle">We all have exactly 24 hours. But how we fill them reveals everything about who we are and the planet we are creating.</div>', unsafe_allow_html=True)
