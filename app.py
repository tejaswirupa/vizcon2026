...
.page-context { font-size:1rem; color:#cbd5e0; line-height:1.8; background:linear-gradient(135deg,#0d0d2b,#1a1a3e); border-radius:10px; padding:1.2rem 1.5rem; border:1px solid #2d2d5e; }
...
st.markdown("""<div style="padding:2.5rem 0 1.5rem 0;">
    ...
    <div style="font-size:3.8rem; font-weight:900; color:#ffffff; line-height:1.05; margin-bottom:0.5rem;">Same 24 Hours.<br>Very Different Planets.</div>
    <div style="font-size:1.25rem; color:#a0aec0; font-weight:300; line-height:1.7;">
...
chapters = [
    ...
    ("03", "🌾", "The Hidden Cost on Your Plate", "Food production and consumption emissions by country. The plate has a price."),
...
st.markdown("""<div class="insight-box">
    ...
    <div style="color:#a0d9b4; font-size:1rem; line-height:1.8;">
        ...
        low footprint (1.69 Earths). The data suggests a third path exists — but the world has to want it.
    </div>
</div>""", unsafe_allow_html=True)
...
st.markdown("""<div style="color:#718096; font-size:0.78rem; text-align:center; margin-top:2rem; line-height:1.8;">
    ...
    SDG Index 2000-2022 · Agrofood CO2 Emissions · OECD Meat Consumption · Sustainable Energy Dataset<br>
    All datasets sourced from Kaggle · Full citations at
    <a href="https://github.com/tejaswirupa/vizcon2026" style="color:#3498db;">github.com/tejaswirupa/vizcon2026</a>
</div>""", unsafe_allow_html=True)
